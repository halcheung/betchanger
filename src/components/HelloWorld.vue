<template>
  <div class="hello">
    ...
    <table style="width:600px;" v-show="hasFirstHalf1">
      <thead>
      <tr>
    ...
    <table style="width:600px;" v-show="hasFirstHalf2">
      <thead>
      <tr>
    ...
    <div class="right-border">
      ...
      <table style="width:250px;" v-show="hasFirstHalf1">
        <thead>
        <tr>
      ...
      <table style="width:250px;" v-show="hasFirstHalf2">
        <thead>
        <tr>
    ...
    <div class="individual">
      ...
      <div style="margin-top:50px;">
        <input type="text" v-model="singlePayA" />
        <input type="text" v-model="singlePayE" />
        <input type="text" v-model="singlePayB" />
      </div>

      <div style="margin-top:40px;" v-show="hasFirstHalf1">
        <input type="text" v-model="singlePayA2" />
        <input type="text" v-model="singlePayE2" />
        <input type="text" v-model="singlePayB2" />
      </div>

      <div style="margin-top:40px;">
        <p>&nbsp;</p>
        <p v-for="scr in scores" style="margin:13px 0;">
          <input v-for="ss in scr" type="text" style="width:80px;margin-right:10px;" v-model="ss.b" />
        </p>
        <p style="margin:5px;text-align:right;">
          <input type="text" style="width:80px;margin-right:10px;" v-model="otherscore" />
        </p>
      </div>

      <div style="margin-top:50px;" v-show="hasFirstHalf2">
        <p>&nbsp;</p>
        <p v-for="scr in scores2" style="margin:13px 0;">
          <input v-for="ss in scr" type="text" style="width:80px;margin-right:10px;" v-model="ss.b" />
        </p>
        <p style="margin:5px;text-align:right;">
          <input type="text" style="width:80px;margin-right:10px;" v-model="otherscore2" />
        </p>
      </div>
...
其他比分201
        * */
        ...
        this.hasFirstHalf1 = false;
        this.hasFirstHalf2 = false;
